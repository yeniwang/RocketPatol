class Play extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('faststar', './assets/faststar.png');
        // load spritesheet
    ...
    create() {
        ...
        // New! add fast star
        this.star = new FastStar(this, game.config.width + borderUISize*8, borderUISize*10, 'faststar', 0, 100).setOrigin(0, 0);
    ...
    update() {
        ...
        if(!this.gameOver) {
            ...
            this.ship02.update();
            this.ship03.update();
            this.star.update();                 // New! fast star
        }
        ...
        if (this.checkCollision(this.p1Rocket, this.star)) {
            this.p1Rocket.reset();
            this.shipExplode(this.star);
        }
